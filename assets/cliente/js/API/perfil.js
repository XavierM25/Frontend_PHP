document.addEventListener("DOMContentLoaded", function () {
  ...
  function fetchProfileData() {
    fetch("https://backend-laravel-wl09.onrender.com/api/profile", {
      ...
      .then((data) => {
        ...
        document.getElementById("apePaCli").value =
          data.data.apellido_paterno || "";
        document.getElementById("apeMaCli").value =
          data.data.apellido_materno || "";
        document.getElementById("fechCli").value =
      ...
      .catch((error) =>
        console.error("Error al obtener datos de perfil:", error.message)
      );
  }
  ...
  document
    ...
    .addEventListener("click", function (event) {
      ...
      fetch(
        `https://backend-laravel-wl09.onrender.com/api/profile/update/${userId}`,
        {
          method: "PATCH",
          headers: {
  ...
  document
    .getElementById("btnUsernameUpdate")
    .addEventListener("click", function (event) {
      event.preventDefault();
      ...
      if (confirm("¿Está seguro de que desea cambiar su nombre de usuario?")) {
        ...
        fetch(
          ...
          .then((response) => {
            if (!response.ok) {
              throw new Error(
                "Error al actualizar el nombre de usuario. Por favor, intenta nuevamente."
              );
            }
            return response.json();
          })
          ...
          .catch((error) => {
            ...
            alert(
              "Hubo un error al actualizar el nombre de usuario. Por favor, intenta nuevamente."
            );
          })
          .finally(() => {
  ...
  document
    .getElementById("btnUpdateImgProfile")
    .addEventListener("click", function (event) {
      event.preventDefault();
      ...
      fetch(
        ...
        .catch((error) => {
          ...
          alert(
            "Hubo un error al actualizar la imagen de perfil. Por favor, intenta nuevamente."
          );
        })
        .finally(() => {
          // Restaurar el estado del botón
