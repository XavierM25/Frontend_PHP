document.addEventListener("DOMContentLoaded", function () {
  ...
  resetPasswordForm.addEventListener("submit", function (event) {
    ...
    if (!validatePassword(newPassword)) {
      alert(
        "La contraseña debe contener al menos una letra mayúscula, una letra minúscula, un símbolo y tener entre 5 a más caracteres."
      );
      return;
    }
    ...
    fetch("https://backend-laravel-wl09.onrender.com/api/reset-password", {
      method: "POST",
      headers: {
